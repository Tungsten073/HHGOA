...
export const SocialEdition: React.FC<Props> = ({ onNavigateToGenerator }) => {
  ...
  return (
    <section id="social-edition" className="relative w-full py-20 overflow-hidden font-syne select-none">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col lg:flex-row gap-8 items-start">
        {/* Vertical Sidebar Label for Desktop */}
        <div className="hidden lg:flex flex-col items-center gap-4 font-mono text-[10px] font-bold text-[#151B2B]/70 uppercase tracking-widest pt-8 border-r-2 border-[#151B2B]/20 pr-6 shrink-0">
          <span>ROAD TO 247</span>
          <span className="text-[#9F452D]">↓</span>
          <span>CULTURE</span>
          <span className="text-[#9F452D]">↓</span>
          <span>ICONS</span>
          <span className="text-[#9F452D]">↓</span>
        ...
        <div className="flex-1 w-full">
          ...
          <header className="mb-10 border-b-2 border-[#151B2B] pb-8 relative">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#151B2B] text-[#F5F1E8] font-mono text-xs font-bold uppercase tracking-widest border border-[#151B2B] shadow-brutal w-max">
                ...
                <span>ARCHIVE // 06 · GOA, INDIA · HHG.26</span>
              </div>
